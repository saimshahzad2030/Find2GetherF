...
export default function MainSection({isLoggedIn}) {
    ...
    <div className={style.mainDiv}>
      ...
      <div className={style.insideDiv}>
       ...
       <div className={style.divChild}>
          ...
          <Link to = {isLoggedIn === false?'/login':'/findingSomeone'}  onClick={()=>{ scrollToTop()}}><Button variant="contained"  sx={{fontWeight:'bold',color:'white',width:'140px',backgroundColor:' rgb(0, 51, 102);'}} >Click here</Button>
          </Link>
        </div>
        ...
        <div className={style.imgDiv}>
          ...
          <Link to = {isLoggedIn === false?'/login':'/foundsomeone'}  onClick={()=>{ scrollToTop()}}>
